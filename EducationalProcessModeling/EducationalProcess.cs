...
namespace EducationalProcessModeling
{
    public class EducationalProcess
    {
        ...
        public EducationalProcess()
        {
            ...
            Student student1 = new Student("Іваненко Іван", "КН-21");
            student1.Grades.AddRange(new int[] { 95, 88, 90 });

            Student student2 = new Student("Петренко Ольга", "КН-21");
        ...
        public void ShowStudentAssessments()
        {
            ...
            {
                Console.Write($"[Студент] {student.FullName} (Група: {student.Group}) | Оцінки: ");
                Console.Write(string.Join(", ", student.Grades));
